...
public class NoExistenClasificacionesConCriteriosCU11 extends javax.swing.JFrame {


    public NoExistenClasificacionesConCriteriosCU11() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("No existen clasificaciones que cumplan");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, -1, 20));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); 
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText(" con los criterios seleccionados.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoExistenClasificacionesConCriteriosCU11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoExistenClasificacionesConCriteriosCU11().setVisible(true);
            }
        });
    }
